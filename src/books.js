...
booksArray.forEach(function(deletedBook){
  return delete deletedBook.details.language
})
...
booksArray.forEach(function(obj){
  let time = (obj.pages * 500) / 90
 obj.readingTime = Math.ceil (time);
})
...
//console.log(dictionaryExample["J. K. Rowling"][3])
